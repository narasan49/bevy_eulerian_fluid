...
use crate::fluid_compute_pipeline::HasBindGroupLayout;
...
mod test {
    ...
    use crate::fluid_compute_pipeline::{HasBindGroupLayout, SingleComputePipeline};

    use super::{FluidComputePass, FluidComputePassPlugin};
    use bevy::{
        prelude::*,
        render::{
