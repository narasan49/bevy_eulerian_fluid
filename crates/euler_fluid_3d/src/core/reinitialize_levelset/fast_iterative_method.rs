...
use bevy_eulerian_fluid_common::{
    ...
    fluid_compute_pipeline::{HasBindGroupLayout, SingleComputePipeline},
};
...
pub(crate) struct FastIterativeInitializeResource {
    ...
    #[storage_texture(2, image_format = R32Uint, dimension = "3d", access = WriteOnly)]
...
pub(crate) struct FastIterativeInitializeActiveLabelResource {
    ...
    #[storage_texture(0, image_format = R32Uint, dimension = "3d", access = ReadOnly)]
    pub labels_in: Handle<Image>,
    #[storage_texture(1, image_format = R32Uint, dimension = "3d", access = WriteOnly)]
...
pub(crate) struct FastIterativeUpdateResource {
    #[storage_texture(0, image_format = R32Uint, dimension = "3d", access = ReadWrite)]
    pub labels: Handle<Image>,
