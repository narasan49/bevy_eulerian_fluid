...
impl Plugin for MultiGridPassPlugin {
    fn build(&self, app: &mut App) {
        embedded_asset!(app, "residual.wgsl");
        embedded_asset!(app, "restriction.wgsl");
        embedded_asset!(app, "prolongation.wgsl");
        app.add_plugins((
...
impl FromWorld for MultiGridPipelines {
    fn from_world(world: &mut World) -> Self {
        ...
        let residual_pipeline = pipeline_cache.queue_compute_pipeline(ComputePipelineDescriptor {
            ...
            shader: load_embedded_asset!(world, "residual.wgsl"),
        ...
        let restriction_pipeline =
            pipeline_cache.queue_compute_pipeline(ComputePipelineDescriptor {
                ...
                shader: load_embedded_asset!(world, "restriction.wgsl"),
        ...
        let prolongation_pipeline =
            pipeline_cache.queue_compute_pipeline(ComputePipelineDescriptor {
                ...
                shader: load_embedded_asset!(world, "prolongation.wgsl"),
