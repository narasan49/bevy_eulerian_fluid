...
fn rotl32_2(x: vec2<u32>) -> vec2<u32> {
...
fn murmurHash3_11(src: u32) -> u32 {
    const seed: u32 = 11111u;
    const c1: u32 = 0xcc9e2d51u;
    const c2: u32 = 0x1b873593u;
...
fn hash11(value: f32) -> f32 {
    let hash = murmurHash3_11(bitcast<u32>(value));
    return bitcast<f32>(hash & 0x007fffffu | 0x3f800000u) - 1.0;
}